...
class ChristmasTree:
    ...
    def draw(self):
        ...
        # (self.center-x, self-center_y), (Self
...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        arcade.draw_lrtb_rectangle_filled(0, SCREEN_WIDTH, 300, 0, (227, 227, 227))
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        if 180 < y < SCREEN_HEIGHT * 3/4 + 30 and 50 < x < SCREEN_WIDTH-50:
